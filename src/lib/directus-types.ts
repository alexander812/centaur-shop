...
export interface paths {
    ...
    "/items/goods_files": {
        ...
        /**
         * List Items
         * @description List the goods_files items.
         */
        get: operations["readItemsGoodsFiles"];
        put?: never;
        /**
         * Create an Item
         * @description Create a new goods_files item.
         */
        post: operations["createItemsGoodsFiles"];
        /**
         * Delete Multiple Items
         * @description Delete multiple existing goods_files items.
         */
        delete: operations["deleteItemsGoodsFiles"];
        options?: never;
        head?: never;
        /**
         * Update Multiple Items
         * @description Update multiple goods_files items at the same time.
         */
        patch: operations["updateItemsGoodsFiles"];
        trace?: never;
    };
    "/items/goods_files/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Retrieve an Item
         * @description Retrieve a single goods_files item by unique identifier.
         */
        get: operations["readSingleItemsGoodsFiles"];
        put?: never;
        post?: never;
        /**
         * Delete an Item
         * @description Delete an existing goods_files item.
         */
        delete: operations["deleteSingleItemsGoodsFiles"];
        options?: never;
        head?: never;
        /**
         * Update an Item
         * @description Update an existing goods_files item.
         */
        patch: operations["updateSingleItemsGoodsFiles"];
        trace?: never;
    };
    "/items/goods_files_1": {
        parameters: {
        ...
        /**
         * List Items
         * @description List the goods_files_1 items.
         */
        get: operations["readItemsGoodsFiles1"];
        put?: never;
        /**
         * Create an Item
         * @description Create a new goods_files_1 item.
         */
        post: operations["createItemsGoodsFiles1"];
        /**
         * Delete Multiple Items
         * @description Delete multiple existing goods_files_1 items.
         */
        delete: operations["deleteItemsGoodsFiles1"];
        options?: never;
        head?: never;
        /**
         * Update Multiple Items
         * @description Update multiple goods_files_1 items at the same time.
         */
        patch: operations["updateItemsGoodsFiles1"];
        trace?: never;
    };
    "/items/goods_files_1/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Retrieve an Item
         * @description Retrieve a single goods_files_1 item by unique identifier.
         */
        get: operations["readSingleItemsGoodsFiles1"];
        put?: never;
        post?: never;
        /**
         * Delete an Item
         * @description Delete an existing goods_files_1 item.
         */
        delete: operations["deleteSingleItemsGoodsFiles1"];
        options?: never;
        head?: never;
        /**
         * Update an Item
         * @description Update an existing goods_files_1 item.
         */
        patch: operations["updateSingleItemsGoodsFiles1"];
        trace?: never;
    };
    "/items/categoties": {
        parameters: {
        ...
        /**
         * List Items
         * @description List the categoties items.
         */
        get: operations["readItemsCategoties"];
        put?: never;
        /**
         * Create an Item
         * @description Create a new categoties item.
         */
        post: operations["createItemsCategoties"];
        /**
         * Delete Multiple Items
         * @description Delete multiple existing categoties items.
         */
        delete: operations["deleteItemsCategoties"];
        options?: never;
        head?: never;
        /**
         * Update Multiple Items
         * @description Update multiple categoties items at the same time.
         */
        patch: operations["updateItemsCategoties"];
        trace?: never;
    };
    "/items/categoties/{id}": {
        parameters: {
        ...
        /**
         * Retrieve an Item
         * @description Retrieve a single categoties item by unique identifier.
         */
        get: operations["readSingleItemsCategoties"];
        put?: never;
        post?: never;
        /**
         * Delete an Item
         * @description Delete an existing categoties item.
         */
        delete: operations["deleteSingleItemsCategoties"];
        options?: never;
        head?: never;
        /**
         * Update an Item
         * @description Update an existing categoties item.
         */
        patch: operations["updateSingleItemsCategoties"];
        trace?: never;
    };
    "/items/goods": {
        parameters: {
        ...
        /**
         * List Items
         * @description List the goods items.
         */
        get: operations["readItemsGoods"];
        put?: never;
        /**
         * Create an Item
         * @description Create a new goods item.
         */
        post: operations["createItemsGoods"];
        /**
         * Delete Multiple Items
         * @description Delete multiple existing goods items.
         */
        delete: operations["deleteItemsGoods"];
        options?: never;
        head?: never;
        /**
         * Update Multiple Items
         * @description Update multiple goods items at the same time.
         */
        patch: operations["updateItemsGoods"];
        trace?: never;
    };
    "/items/goods/{id}": {
        parameters: {
        ...
        /**
         * Retrieve an Item
         * @description Retrieve a single goods item by unique identifier.
         */
        get: operations["readSingleItemsGoods"];
        put?: never;
        post?: never;
        /**
         * Delete an Item
         * @description Delete an existing goods item.
         */
        delete: operations["deleteSingleItemsGoods"];
        options?: never;
        head?: never;
        /**
         * Update an Item
         * @description Update an existing goods item.
         */
        patch: operations["updateSingleItemsGoods"];
        trace?: never;
    };
}
...
export interface components {
    schemas: {
        ...
        Collections: {
            ...
            hidden?: boolean;
            singleton?: boolean;
            /** @description $t:field_options.directus_collections.collection_naming_translations_note */
        ...
        ItemsGoodsFiles1: {
            id?: number;
            goods_id?: (number | components["schemas"]["ItemsGoods"]) | null;
        ...
        ItemsGoods: {
            ...
            main_image?: (string | components["schemas"]["Files"]) | null;
            description?: string | null;
            category?: unknown;
            title?: string | null;
            decsription_images?: (number | components["schemas"]["ItemsGoodsFiles1"])[] | null;
        };
    };
    responses: {
...
export interface operations {
    ...
    readItemsGoodsFiles: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["ItemsGoodsFiles"][];
                        meta?: components["schemas"]["x-metadata"];
                    };
                };
            };
    ...
    createItemsGoodsFiles: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsGoodsFiles"][] | components["schemas"]["ItemsGoodsFiles"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    updateSingleItemsGoodsFiles: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsGoodsFiles"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    readItemsGoodsFiles1: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["ItemsGoodsFiles1"][];
                        meta?: components["schemas"]["x-metadata"];
                    };
                };
            };
    ...
    createItemsGoodsFiles1: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsGoodsFiles1"][] | components["schemas"]["ItemsGoodsFiles1"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    updateSingleItemsGoodsFiles1: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsGoodsFiles1"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    readItemsCategoties: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["ItemsCategoties"][];
                        meta?: components["schemas"]["x-metadata"];
                    };
                };
            };
    ...
    createItemsCategoties: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsCategoties"][] | components["schemas"]["ItemsCategoties"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    updateSingleItemsCategoties: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsCategoties"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    readItemsGoods: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["ItemsGoods"][];
                        meta?: components["schemas"]["x-metadata"];
                    };
                };
            };
    ...
    createItemsGoods: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsGoods"][] | components["schemas"]["ItemsGoods"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    updateSingleItemsGoods: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsGoods"];
            };
        };
        responses: {
            /** @description Successful request */
